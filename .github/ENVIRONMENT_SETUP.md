***REMOVED*** GitHub Actions Environment Setup
...
***REMOVED******REMOVED******REMOVED*** 1. Production Environment
- **Name**: `production`
...
***REMOVED******REMOVED******REMOVED*** 2. No Environment (CI/Build Jobs)
- CI jobs (lint, typecheck, build) run without environment restrictions

***REMOVED******REMOVED*** Setting Up GitHub Environments

***REMOVED******REMOVED******REMOVED*** Step 1: Create Production Environment
...
***REMOVED******REMOVED******REMOVED*** Step 2: Configure Deployment Protection Rules (Optional but Recommended)
...
***REMOVED******REMOVED******REMOVED*** Step 3: Add Secrets to Repository
...
***REMOVED******REMOVED******REMOVED*** Step 4: Verify Environment URLs (Optional)
...
***REMOVED******REMOVED*** IAM User Setup (AWS)

Create a dedicated IAM user for CI/CD deployments:

***REMOVED******REMOVED******REMOVED*** 1. Create IAM User
```bash
aws iam create-user --user-name workermill-ci-github
```

***REMOVED******REMOVED******REMOVED*** 2. Create Access Keys
```bash
...
***REMOVED******REMOVED******REMOVED*** 3. Attach Minimal Policy
...
***REMOVED******REMOVED******REMOVED*** 4. Best Practices
...
***REMOVED******REMOVED******REMOVED*** Repository Secrets vs Environment Secrets
...
***REMOVED******REMOVED******REMOVED*** Rotating Secrets
...
***REMOVED******REMOVED*** Deployment Protection Strategies

***REMOVED******REMOVED******REMOVED*** Option 1: Require Approval (Recommended for Production)

```yaml
***REMOVED*** In GitHub UI: Settings → Environments → production
- Require reviewers: ✅
...
***REMOVED******REMOVED******REMOVED*** Option 2: Branch Protection

```yaml
***REMOVED*** In GitHub UI: Settings → Branches → main
...
***REMOVED******REMOVED******REMOVED*** Option 3: Scheduled Deployments
...
***REMOVED******REMOVED*** Audit & Monitoring

***REMOVED******REMOVED******REMOVED*** GitHub Actions Audit Log
...
***REMOVED******REMOVED******REMOVED*** AWS CloudTrail
...
***REMOVED******REMOVED******REMOVED*** Deployment Timeline
...
***REMOVED******REMOVED******REMOVED*** Secret Not Available in Workflow
...
***REMOVED******REMOVED******REMOVED*** Deployment Approval Stuck
...
***REMOVED******REMOVED******REMOVED*** IAM Access Denied
...
3. Test permissions locally with AWS CLI:
   ```bash
   aws sts assume-role --role-arn arn:aws:iam::AWS_ACCOUNT_ID:role/... --role-session-name test
   ```
