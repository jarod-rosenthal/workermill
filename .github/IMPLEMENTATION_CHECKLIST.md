...
#### Verification
```bash
# Test secrets are accessible (optional, in workflow logs)
# GitHub will show if secrets are masked in logs (*****)
```
...
2. [ ] Set permissions:
   ...
   - [ ] Copy policy from [WORKFLOW_GUIDE.md](./WORKFLOW_GUIDE.md#required-iam-permissions)
...
#### IAM Policy Required
Copy policy from [WORKFLOW_GUIDE.md](./WORKFLOW_GUIDE.md#required-iam-permissions) or:
  ...
  "Statement": [
    {
      ...
      "Resource": [
        "arn:aws:ecr:us-east-1:593971626975:repository/workermill-dev/api",
        "arn:aws:ecr:us-east-1:593971626975:repository/workermill-dev/worker"
      ]
    },
    {
      "Effect": "Allow",
      ...
      "Resource": [
        "arn:aws:ecs:us-east-1:593971626975:service/workermill-dev/workermill-dev-api",
        "arn:aws:ecs:us-east-1:593971626975:task-definition/workermill-dev-api:*",
        "arn:aws:ecs:us-east-1:593971626975:task-definition/workermill-dev-worker:*"
      ]
    },
    {
      "Effect": "Allow",
      ...
      "Resource": [
        "arn:aws:iam::593971626975:role/ecsTaskExecutionRole",
        "arn:aws:iam::593971626975:role/ecsTaskRole"
      ]
    },
    {
      "Effect": "Allow",
      ...
      "Resource": [
        "arn:aws:s3:::workermill-dev-frontend-593971626975/*",
        "arn:aws:s3:::workermill-dev-frontend-593971626975"
      ]
    },
    {
      ...
      "Resource": "arn:aws:cloudfront::593971626975:distribution/E15CA3N5TI2ZR2"
    }
  ]
}
```

### 6. Verify AWS Credentials (Optional)
...
#### Option A: Test CI on Feature Branch
```bash
# Create and push a feature branch
git checkout -b test/ci-pipeline
git push -u origin test/ci-pipeline

# Go to: https://github.com/jarod-rosenthal/workermill/actions
# Wait for workflow to run
# Should show: ✅ CI checks passed
```

#### Option B: Test Full Deployment on Main
```bash
# Ensure main branch has your code with the workflow
git checkout main
git pull origin main

# Make a small change (e.g., update README)
# Push to main (assuming branch protection allows direct push)
git push origin main

# Go to: https://github.com/jarod-rosenthal/workermill/actions
# Watch deployment progress:
#   1. CI checks run (2-3 min)
#   2. Deployments start (if CI passes)
#   3. API deployment (5-10 min)
#   4. Frontend deployment (2-5 min)
#   5. Worker deployment (3-5 min)
```
