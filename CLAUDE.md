...
***REMOVED******REMOVED*** ABSOLUTE RULES
...
***REMOVED******REMOVED******REMOVED*** DO NOT Hardcode Timeouts/Thresholds/Limits
...
***REMOVED******REMOVED******REMOVED*** DO NOT Directly INSERT Board Cards
...
***REMOVED******REMOVED******REMOVED*** Other Critical Rules
...
***REMOVED******REMOVED******REMOVED*** Quality Gates (read `worker/epic/executor.ts` for details)
...
***REMOVED******REMOVED*** Recent Changes (max 5)
