...
```bash
cd worker/execution && npm run build   ***REMOVED*** After editing, rebuild and commit compiled output
```
...
```bash
***REMOVED*** Production (default - workermill.com)
./deploy.sh --api                    ***REMOVED*** Deploy API to production
./deploy.sh --worker                 ***REMOVED*** Deploy worker image to production
./deploy.sh --frontend               ***REMOVED*** Deploy frontend to production
./deploy.sh --all                    ***REMOVED*** Deploy everything to production

***REMOVED*** Development (dev.workermill.com)
./deploy.sh --api --env dev          ***REMOVED*** Deploy API to development
./deploy.sh --all --env dev          ***REMOVED*** Deploy everything to development
...
SCM_BASE_URL=https://gitlab.example.com  ***REMOVED*** For self-hosted
SCM_TOKEN=<token>
BITBUCKET_USERNAME=<username>  ***REMOVED*** BitBucket only
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Mode Comparison
...
---
***REMOVED******REMOVED******REMOVED*** **CRITICAL: TERRAFORM IS THE ONLY SOURCE OF TRUTH**
---
...
***REMOVED******REMOVED*** Organization Settings
...
***REMOVED******REMOVED******REMOVED*** Common Debugging Patterns
