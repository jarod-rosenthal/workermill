...
```bash
***REMOVED*** After deploy.sh fails, get the digest from the output (e.g., sha256:abc123...)
***REMOVED*** Then apply terraform with the digest:
cd infrastructure/terraform/environments/dev
...
***REMOVED******REMOVED******REMOVED*** Aider Integration Details
