...
3. Monitor CI run 34067913059 for Linux/macOS × Node 22.12.0/22.22.2. Pushing this branch and CI qualification are authorized. No merge, publication, tag, release, paid evaluation or worktree cleanup is authorized. Do not claim a platform passed until its unit and installed-package jobs finish.
