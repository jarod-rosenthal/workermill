***REMOVED*** Swagger/OpenAPI Documentation Implementation
...
***REMOVED******REMOVED******REMOVED*** 1. Core Configuration (`api/src/config/swagger.ts`)
...
***REMOVED******REMOVED******REMOVED*** 2. Swagger UI Integration (`api/src/index.ts`)
...
***REMOVED******REMOVED******REMOVED*** 3. Endpoint Documentation
...
***REMOVED******REMOVED******REMOVED*** 4. Dependencies Added
...
***REMOVED******REMOVED******REMOVED*** 5. Documentation (`api/docs/API_DOCUMENTATION.md`)
...
***REMOVED******REMOVED*** Accessing the Documentation
