***REMOVED*** WorkerMill API Documentation

***REMOVED******REMOVED*** Swagger/OpenAPI Documentation

The WorkerMill API now includes comprehensive OpenAPI 3.0 documentation powered by Swagger.

***REMOVED******REMOVED******REMOVED*** Accessing the Documentation
...
***REMOVED******REMOVED******REMOVED*** 1. Bearer Token (JWT)

Used for user-facing endpoints (dashboard, settings, etc.).

```bash
***REMOVED*** Example: Get billing status
...
***REMOVED******REMOVED*** Documented Endpoints

***REMOVED******REMOVED******REMOVED*** Billing
...
***REMOVED******REMOVED*** Using Swagger UI

***REMOVED******REMOVED******REMOVED*** Testing Authenticated Endpoints
...
***REMOVED******REMOVED*** Code Generation
...
***REMOVED******REMOVED******REMOVED*** Database-backed Logs
