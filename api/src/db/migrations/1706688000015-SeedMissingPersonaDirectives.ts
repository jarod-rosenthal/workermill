  ...
  implements MigrationInterface
{
  ...
  private backendDeveloper = `# Backend Developer
...
`;
  ...
  private frontendDeveloper = `# Frontend Developer
...
`;
  ...
  private devopsEngineer = `# DevOps Engineer
...
`;
  ...
  private qaEngineer = `# QA Engineer
...
`;
  ...
  private securityEngineer = `# Security Engineer
...
`;
  ...
  private techWriter = `# Technical Writer
...
`;
  ...
  private manager = `# Virtual Manager Task Instructions
...
### \`analyze_logs\` - Log Analysis (Manager Mode)
