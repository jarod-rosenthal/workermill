  ...
  implements MigrationInterface
{
  ...
  private originalContent = `# Team Collaboration Protocol
...
`;
  ...
  private directiveContent = `# Team Collaboration Protocol
...
Write a question in your output using the Q-### format:
...
| Type | When | Format |
|------|------|--------|
| Decision | Architectural choices affecting others | DEC-###: description |
| Question | Need expertise outside your specialty | Q-###: question |
| Targeted Question | Need a specific expert | Q-SECURITY-###: question |
| Blocking Question | Cannot proceed without answer | Q-BLOCKING-###: question |
| Answer | Responding to sibling question | A-### (re: Q-###): answer |
