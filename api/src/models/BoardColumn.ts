...
export const DEFAULT_COLUMNS: Array<{
  ...
  { name: "Backlog", columnType: "backlog", position: 0, color: "#6b7280", isDefault: true },
  { name: "In Progress", columnType: "in_progress", position: 1, color: "#f59e0b", isDefault: false },
  { name: "Review", columnType: "review", position: 2, color: "#8b5cf6", isDefault: false },
  { name: "PR Approved", columnType: "pr_approved", position: 3, color: "#3b82f6", isDefault: false },
  { name: "Deployed", columnType: "deployed", position: 4, color: "#10b981", isDefault: false },
];
