      ...
      if (!tokenData) {
        ...
        res.status(400).send(`
          ...
          <head>
            ...
            <style>
              body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 40px 20px; background: ***REMOVED***f4f4f5; }
              .container { max-width: 500px; margin: 0 auto; background: white; padding: 40px; border-radius: 8px; text-align: center; }
              h1 { color: ***REMOVED***18181b; margin-bottom: 16px; }
              p { color: ***REMOVED***71717a; line-height: 1.6; }
              a { color: ***REMOVED***3b82f6; }
            </style>
          </head>
          <body>
            <div class="container">
      ...
      res.send(`
        ...
        <head>
          ...
          <style>
            ...
            h1 { color: ***REMOVED***18181b; margin-bottom: 16px; }
            p { color: ***REMOVED***71717a; line-height: 1.6; }
            .success { color: ***REMOVED***166534; background: ***REMOVED***dcfce7; padding: 12px 20px; border-radius: 6px; display: inline-block; margin-bottom: 20px; }
            a { color: ***REMOVED***3b82f6; }
          </style>
        </head>
        <body>
