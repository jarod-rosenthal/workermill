...
export class ECSTaskRunner {
  ...
  async runWorkerTask(
    ...
    const environment = [
      ...
      { name: "TICKET_SYSTEM", value: credentials.issueTrackerProvider === "github-issues" ? "github" : (credentials.issueTrackerProvider || "internal") },
      ...
      },
      {
        ...
        value: task.jiraFields?.qualityGates
