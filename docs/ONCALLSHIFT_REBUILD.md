...
```
Bucket:         workermill-terraform-state-AWS_ACCOUNT_ID
...
ALERTS_QUEUE_URL=https://sqs.us-east-2.amazonaws.com/AWS_ACCOUNT_ID/oncallshift-dev-alerts
NOTIFICATIONS_QUEUE_URL=https://sqs.us-east-2.amazonaws.com/AWS_ACCOUNT_ID/oncallshift-dev-notifications
SES_FROM_EMAIL=noreply@oncallshift.com
SNS_PUSH_TOPIC_ARN=arn:aws:sns:us-east-2:AWS_ACCOUNT_ID:oncallshift-dev-push-events
