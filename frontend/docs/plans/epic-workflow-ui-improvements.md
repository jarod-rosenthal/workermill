***REMOVED*** Epic Workflow UI Improvements Plan
...
***REMOVED******REMOVED******REMOVED*** Dashboard.tsx Execution Plan Display (lines 1875-2100)
...
***REMOVED******REMOVED******REMOVED*** Epic Mode Detection (lines 2473-2478)
...
***REMOVED******REMOVED******REMOVED*** Existing Components
...
***REMOVED******REMOVED*** 1. Auto-collapse Execution Plan When Epic Starts Executing
...
***REMOVED******REMOVED*** 2. New Icons for Epic Workflow
...
***REMOVED******REMOVED******REMOVED*** Recommended Icon Mapping
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Plan Header (around line 1901)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Epic Badge (after line 1906)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Helper Function
...
***REMOVED******REMOVED*** 3. Progress Indicator (Percentage-Based)

***REMOVED******REMOVED******REMOVED*** Problem

No prominent visual indicator showing overall Epic progress as a percentage relative to total subtasks.

***REMOVED******REMOVED******REMOVED*** Solution Options

***REMOVED******REMOVED******REMOVED******REMOVED*** Option A: Circular Progress Ring (Recommended)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Option B: Inline Progress Bar
...
***REMOVED******REMOVED******REMOVED*** Helper Function for Progress Calculation
...
***REMOVED******REMOVED******REMOVED*** New Imports Needed in Dashboard.tsx
...
***REMOVED******REMOVED*** Visual Mockup (ASCII)

***REMOVED******REMOVED******REMOVED*** Before (Standard Plan)
```
┌─────────────────────────────────────────────────┐
...
***REMOVED******REMOVED******REMOVED*** After (Epic Plan)
```
┌─────────────────────────────────────────────────┐
