            ...
            >
              ...
              <defs>
                <marker
                  ...
                  orient="auto"
                >
                  <polygon points="0 0, 10 3.5, 0 7" fill="***REMOVED***6366f1" />
                </marker>
                <marker
                  ...
                  orient="auto"
                >
                  <polygon points="0 0, 10 3.5, 0 7" fill="***REMOVED***22c55e" />
                </marker>
              </defs>
                ...
                {rootNodes.map((node) => {
                  ...
                  return (
                    <path
                      ...
                      d={path}
                      fill="none"
                      stroke={hasParallelRoots ? "***REMOVED***22c55e" : "***REMOVED***6366f1"}
                      strokeWidth={2}
                      markerEnd={
                        hasParallelRoots
                          ? "url(***REMOVED***arrowhead-parallel)"
                          : "url(***REMOVED***arrowhead)"
                      }
                    />
                  );
                })}
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs">
            ...
            <span className="border-l border-border pl-4 flex items-center gap-1.5">
              <span
                ...
                style={{ backgroundColor: "***REMOVED***22c55e" }}
              ></span>
            ...
            <span className="flex items-center gap-1.5">
              <span
                className="w-4 h-0.5 inline-block"
                style={{ backgroundColor: "***REMOVED***6366f1" }}
              ></span>
      ...
      >
        <defs>
          <marker
            ...
            orient="auto"
          >
            <polygon points="0 0, 8 3, 0 6" fill="***REMOVED***6366f1" />
          </marker>
          <marker
          ...
          {rootNodes.map((node) => {
            ...
            return (
              <path
                ...
                markerEnd={
                  hasParallelRoots
                    ? "url(***REMOVED***arrowhead-inline-parallel)"
                    : "url(***REMOVED***arrowhead-inline)"
                }
              />
            );
          })}
            ...
            return (
              <g key={node.id} transform={`translate(${x}, ${y})`}>
                ...
                <text
                  ...
                  fill="currentColor"
                >
                  {getStatusIndicator(node.status)} ***REMOVED***{node.index}
                </text>
          ...
          {rootNodes.map((node) => {
            ...
            return (
              <path
                ...
                markerEnd={
                  hasParallelRoots
                    ? "url(***REMOVED***arrowhead-embedded-parallel)"
                    : "url(***REMOVED***arrowhead-embedded)"
                }
              />
            );
          })}
          ...
          {taskEdges.map((edge, idx) => {
            ...
            return (
              <path
                ...
                stroke="***REMOVED***6366f1"
                strokeWidth={1.5}
                markerEnd="url(***REMOVED***arrowhead-embedded)"
              />
            );
          })}
        </g>
          ...
          {nodes.map((node) => {
            ...
            return (
              <g key={node.id} transform={`translate(${x}, ${y})`}>
                ...
                {/* Title */}
                <text x={10} y={36} fontSize="10" fill="***REMOVED***d1d5db">
                  {node.title}
                </text>
              </g>
            );
