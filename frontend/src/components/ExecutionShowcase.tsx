...
function EpicSidebar({ epics }: { epics: Epic[] }) {
  return (
    <div className="w-[200px] min-w-[200px] bg-[#1a1a1c] border-r border-white/[0.06] py-4 px-2.5 flex flex-col gap-0.5 overflow-hidden">
  ...
  return (
    <div className="flex-1 relative flex flex-col overflow-hidden">
      ...
      <div className="flex-1 p-5 relative">
        ...
        {/* Context menu */}
        <div className="absolute top-14 left-[38%] bg-[#2d2d30] border border-white/10 rounded-lg shadow-2xl shadow-black/40 py-1.5 w-60 z-10">
