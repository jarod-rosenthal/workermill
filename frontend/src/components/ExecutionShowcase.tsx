...
function EpicSidebar({ epics }: { epics: Epic[] }) {
  return (
    <div className="w-full lg:w-[35%] bg-[***REMOVED***252526] border-r border-white/5 p-3 flex flex-col gap-1 overflow-hidden">
...
function ContextMenuContent() {
  return (
    <div className="flex-1 p-4 relative">
      ...
      <div className="absolute top-8 left-1/3 bg-[***REMOVED***2d2d30] border border-white/10 rounded-lg shadow-2xl py-1 w-64 z-10">
  ...
  return (
    <div className="flex-1 p-4 space-y-3 overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="mt-2 flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
        ...
        <span className="text-sm text-emerald-400 font-medium">PR ***REMOVED***42 ready for review</span>
      </div>
...
function CaptionBar({ caption, frameIndex, totalFrames }: { caption: string; frameIndex: number; totalFrames: number }) {
  return (
    <div className="flex items-center justify-between px-4 py-2.5 bg-[***REMOVED***1e1e1e] border-t border-white/5">
      ...
      <div className="relative container mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            ...
            <div className="relative bg-[***REMOVED***1e1e1e] rounded-xl border border-white/10 overflow-hidden shadow-2xl">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-[***REMOVED***323233] border-b border-white/5">
