...
export function TerminalLogViewer({ taskId, height = "400px" }: TerminalLogViewerProps) {
  ...
  if (loading) {
    return (
      <div
        className="bg-[***REMOVED***1a1b26] rounded-lg border border-border flex items-center justify-center"
        style={{ height }}
      >
  ...
  if (error) {
    return (
      <div
        className="bg-[***REMOVED***1a1b26] rounded-lg border border-red-500/30 flex items-center justify-center"
        style={{ height }}
      >
  ...
  return (
    <div className="relative" style={{ height }}>
      {/* Terminal Header */}
      <div className="bg-[***REMOVED***1a1b26] border border-border rounded-t-lg px-3 py-2 flex items-center justify-between">
      ...
      <div
        ref={containerRef}
        className="bg-[***REMOVED***1a1b26] border-x border-b border-border rounded-b-lg overflow-y-auto font-mono text-xs leading-relaxed p-3"
