...
function getCardIcon(brand: string) {
  ...
  if (brandLower === "visa") {
    return (
      <svg className="w-8 h-6" viewBox="0 0 48 32" fill="none">
        <rect width="48" height="32" rx="4" fill="***REMOVED***1A1F71" />
        <path
  ...
  if (brandLower === "mastercard") {
    return (
      <svg className="w-8 h-6" viewBox="0 0 48 32" fill="none">
        <rect width="48" height="32" rx="4" fill="***REMOVED***252525" />
        <circle cx="18" cy="16" r="8" fill="***REMOVED***EB001B" />
        <circle cx="30" cy="16" r="8" fill="***REMOVED***F79E1B" />
        <path
  ...
  if (brandLower === "amex" || brandLower === "american express") {
    return (
      <svg className="w-8 h-6" viewBox="0 0 48 32" fill="none">
        <rect width="48" height="32" rx="4" fill="***REMOVED***016FD0" />
        <path
