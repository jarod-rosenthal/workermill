  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-full" preserveAspectRatio="none">
      ...
      <g transform={`translate(${padding.left}, ${height - 8})`}>
        <line x1="0" y1="0" x2="10" y2="0" stroke="***REMOVED***06b6d4" strokeWidth={2} />
        <text x="12" y="3" fontSize="6" fill="currentColor" opacity={0.6}>Actual</text>

        <line x1="35" y1="0" x2="45" y2="0" stroke="***REMOVED***f59e0b" strokeWidth={2} strokeDasharray="2,1" />
        <text x="47" y="3" fontSize="6" fill="currentColor" opacity={0.6}>Forecast</text>

        <line x1="75" y1="0" x2="85" y2="0" stroke="***REMOVED***94a3b8" strokeWidth={1} strokeDasharray="2,1" />
