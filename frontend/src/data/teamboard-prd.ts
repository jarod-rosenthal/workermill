...
***REMOVED*** TeamBoard — Full Build Specification
...
***REMOVED******REMOVED*** Design Standards
...
***REMOVED******REMOVED******REMOVED*** Visual Identity
...
***REMOVED******REMOVED******REMOVED*** Interaction Design
...
***REMOVED******REMOVED******REMOVED*** Page-Level Polish
...
***REMOVED******REMOVED******REMOVED*** Design Anti-Patterns (Do NOT)
...
***REMOVED******REMOVED******REMOVED*** Pinned Dependencies (DO NOT change)
...
model Column {
  ...
  name     String
  position Int    @default(0)
  color    String @default("***REMOVED***6B7280")
  wipLimit Int?
  cards    Card[]
}
...
***REMOVED******REMOVED******REMOVED*** Workspaces
...
***REMOVED******REMOVED******REMOVED*** Boards & Columns
...
***REMOVED******REMOVED******REMOVED*** Activity & Stats
...
***REMOVED******REMOVED******REMOVED*** Starred Boards
...
***REMOVED******REMOVED******REMOVED*** SSE Real-Time Stream
...
***REMOVED******REMOVED******REMOVED*** Seed Endpoint
...
***REMOVED******REMOVED******REMOVED*** RBAC Enforcement
...
***REMOVED******REMOVED******REMOVED*** Kanban Board (Main Feature)
...
***REMOVED******REMOVED******REMOVED*** Activity Feed
...
***REMOVED******REMOVED******REMOVED*** Members Page
...
***REMOVED******REMOVED******REMOVED*** Settings Page
...
***REMOVED******REMOVED******REMOVED*** Workspace-Level Search
...
***REMOVED******REMOVED******REMOVED*** Manifest & Install
...
\`\`\`json
{
  ...
  "display": "standalone",
  "background_color": "***REMOVED***ffffff",
  "theme_color": "***REMOVED***2563eb",
  "orientation": "any",
  "icons": [
...
***REMOVED******REMOVED******REMOVED*** Service Worker & Offline Caching
...
***REMOVED******REMOVED******REMOVED*** Offline Action Queue
...
***REMOVED******REMOVED******REMOVED*** Mobile-Native Interactions
...
***REMOVED******REMOVED*** Seed Data (CRITICAL — Makes or Breaks the Demo)
...
***REMOVED******REMOVED******REMOVED*** 5 Labels
- "Bug" (red), "Feature" (blue), "Enhancement" (green), "Documentation" (purple), "Urgent" (orange)

***REMOVED******REMOVED******REMOVED*** 25 Activity Entries
...
***REMOVED******REMOVED******REMOVED*** Card Details
...
│   │   ├── workspaces/page.tsx
│   │   ├── [workspace]/
│   │   │   ├── page.tsx          ***REMOVED*** Redirects to dashboard
│   │   │   ├── layout.tsx        ***REMOVED*** Sidebar layout
│   │   │   ├── dashboard/page.tsx
│   │   │   ├── activity/page.tsx
│   │   │   ├── members/page.tsx
│   │   │   ├── settings/page.tsx
...
│   │       └── ... (all API routes)
│   ├── components/
│   │   ├── ui/               ***REMOVED*** shadcn/ui (customized theme)
│   │   ├── layout/           ***REMOVED*** Sidebar, Header, BottomNav
│   │   ├── board/            ***REMOVED*** BoardView, Column, Card, CardDetail
│   │   ├── dashboard/        ***REMOVED*** Charts, StatCards
│   │   └── shared/           ***REMOVED*** LoadingSpinner, ErrorBoundary, EmptyState
│   ├── lib/
│   │   ├── auth.ts           ***REMOVED*** NextAuth config
│   │   ├── prisma.ts         ***REMOVED*** Prisma client singleton
│   │   ├── utils.ts
│   │   ├── validations.ts    ***REMOVED*** Zod schemas
│   │   └── offline-queue.ts  ***REMOVED*** IndexedDB action queue
│   ├── hooks/
│   │   ├── useSSE.ts
│   │   └── useOffline.ts
│   └── types/
...
***REMOVED******REMOVED******REMOVED*** package.json scripts
...
**Usage:**
\`\`\`bash
***REMOVED*** Start local database
docker compose up -d --wait

***REMOVED*** Run app against local database
npm run dev

***REMOVED*** Run tests against local database
npm run test
npm run test:e2e
...
\`\`\`bash
***REMOVED*** Database — local PostgreSQL via docker-compose
...
***REMOVED*** Seed endpoint protection
...
***REMOVED******REMOVED******REMOVED*** CI Pipeline (\`.github/workflows/ci.yml\`)
...
***REMOVED******REMOVED******REMOVED*** Deploy Pipeline (\`.github/workflows/deploy.yml\`)
...
***REMOVED******REMOVED******REMOVED*** GitHub Secrets (pre-configured)
...
***REMOVED******REMOVED******REMOVED*** Vercel (pre-configured)
...
***REMOVED******REMOVED******REMOVED*** Vercel Production Config
...
***REMOVED******REMOVED******REMOVED*** Vercel Deployment — Known Failure Modes
...
***REMOVED******REMOVED******REMOVED*** Test Conventions
...
***REMOVED******REMOVED*** Post-Deploy Smoke Test
