...
const FALLBACK_PERSONAS: Record<string, PersonaMeta> = {
  ...
  architect: { slug: "architect", name: "Architect", emoji: "\u{1F3D7}\uFE0F", color: "#7C3AED", shortLabel: "Architect" },
  data_ml_engineer: { slug: "data_ml_engineer", name: "Data & ML Engineer", emoji: "\u{1F4CA}", color: "#14B8A6", shortLabel: "Data/ML" },
  mobile_developer: { slug: "mobile_developer", name: "Mobile Developer", emoji: "\u{1F4F1}", color: "#22C55E", shortLabel: "Mobile" },
