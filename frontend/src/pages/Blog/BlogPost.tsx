...
const postContent: Record<string, React.ReactNode> = {
  "anatomy-of-a-one-shot-spec": (
    <>
      ...
      <div className="article-callout">
        <strong>Spec Rule ***REMOVED***1:</strong>
      ...
      <ul>
        <li>
          ...
          (<code>GET /flags/&***REMOVED***123;id&***REMOVED***125;</code>).
        </li>
        <li>
      ...
      <div className="article-callout">
        <strong>Spec Rule ***REMOVED***2:</strong>
      ...
      <div className="article-callout">
        <strong>Spec Rule ***REMOVED***3:</strong>
      ...
      <div className="article-callout">
        <strong>Spec Rule ***REMOVED***4:</strong>
      ...
      <div className="article-callout">
        <strong>Spec Rule ***REMOVED***5:</strong>
