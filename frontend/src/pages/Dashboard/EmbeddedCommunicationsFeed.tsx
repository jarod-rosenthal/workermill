...
> = {
  ...
  api_developer: { emoji: "\u{1F50C}", shortLabel: "API" },
  ...
  data_engineer: { emoji: "\u{1F4CA}", shortLabel: "Data" },
  ml_engineer: { emoji: "\u{1F916}", shortLabel: "ML" },
  mobile_developer_ios: { emoji: "\u{1F34E}", shortLabel: "iOS" },
