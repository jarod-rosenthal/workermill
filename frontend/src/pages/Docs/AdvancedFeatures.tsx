    ...
    <div className="space-y-12">
      ...
      <nav className="bg-card border border-border rounded-xl p-5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-3">
          ...
          <a href="***REMOVED***ai-support-agent" className="flex items-center gap-2 p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30 hover:bg-cyan-500/20 transition-colors">
