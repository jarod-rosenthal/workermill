    ...
    <div className="space-y-12">
      ...
      <nav className="bg-card border border-border rounded-xl p-5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
          ...
          <a href="***REMOVED***coordination" className="flex items-center gap-2 p-3 rounded-lg bg-purple-500/10 border border-purple-500/30 hover:bg-purple-500/20 transition-colors">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
          <a href="***REMOVED***memory-system" className="flex items-center gap-2 p-3 rounded-lg bg-violet-500/10 border border-violet-500/30 hover:bg-violet-500/20 transition-colors">
            <Brain className="w-4 h-4 text-violet-500" />
            <span className="text-sm font-medium text-foreground">Memory System</span>
          </a>
          <a href="***REMOVED***codebase-intelligence" className="flex items-center gap-2 p-3 rounded-lg bg-indigo-500/10 border border-indigo-500/30 hover:bg-indigo-500/20 transition-colors">
            <Search className="w-4 h-4 text-indigo-500" />
            <span className="text-sm font-medium text-foreground">Codebase Intelligence</span>
          </a>
          <a href="***REMOVED***warm-pool" className="flex items-center gap-2 p-3 rounded-lg bg-orange-500/10 border border-orange-500/30 hover:bg-orange-500/20 transition-colors">
            <Box className="w-4 h-4 text-orange-500" />
            <span className="text-sm font-medium text-foreground">Warm Container Pool</span>
          </a>
          <a href="***REMOVED***code-quality" className="flex items-center gap-2 p-3 rounded-lg bg-rose-500/10 border border-rose-500/30 hover:bg-rose-500/20 transition-colors">
          ...
          <div className="space-y-3">
            <div className="bg-background rounded-lg p-4 border border-border">
              <div className="text-sm">
                ...
                <code className="text-foreground">workermill-&***REMOVED***123;env&***REMOVED***125;-worker-state-&***REMOVED***123;account_id&***REMOVED***125;</code>
              </div>
              <div className="text-sm mt-1">
                <span className="text-muted-foreground">Path: </span>
                <code className="text-foreground">s3://&***REMOVED***123;bucket&***REMOVED***125;/&***REMOVED***123;taskId&***REMOVED***125;/checkpoint.json</code>
              </div>
            </div>
