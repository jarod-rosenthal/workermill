    ...
    <div className="space-y-12">
      ...
      <nav className="bg-card border border-border rounded-xl p-5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
          <a href="***REMOVED***ralph" className="flex items-center gap-2 p-3 rounded-lg bg-green-500/10 border border-green-500/30 hover:bg-green-500/20 transition-colors">
