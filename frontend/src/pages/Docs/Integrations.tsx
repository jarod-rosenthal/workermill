        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-[***REMOVED***4A154B]/20 flex items-center justify-center">
                <MessageSquare className="w-5 h-5 text-[***REMOVED***4A154B]" />
              </div>
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-[***REMOVED***5059C9]/20 flex items-center justify-center">
                <MessageCircle className="w-5 h-5 text-[***REMOVED***5059C9]" />
              </div>
