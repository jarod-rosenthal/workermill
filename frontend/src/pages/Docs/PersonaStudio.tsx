    ...
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mt-8">
        ...
        <div className="not-prose bg-muted/30 border border-border rounded-xl p-4 mt-4 font-mono text-sm">
          <div className="text-muted-foreground mb-2">***REMOVED*** Example label mappings</div>
        ...
        <div className="not-prose bg-muted/30 border border-border rounded-xl p-4 mt-4 font-mono text-sm">
          <div className="text-muted-foreground mb-2">***REMOVED*** Example keyword patterns</div>
          <div className="space-y-1">
      ...
      <section className="mt-8">
        ...
        <p>
          WorkerMill includes 14 built-in personas covering common development roles:
        </p>
