      ...
      {managerPersona && (
        <section className="space-y-4">
          ...
          <div
            ...
            style={{ borderColor: `${managerPersona.color || "***REMOVED***6366F1"}40` }}
          >
            <div className="flex items-start gap-4">
              <div
                className="p-3 rounded-lg"
                style={{ backgroundColor: `${managerPersona.color || "***REMOVED***6366F1"}18` }}
              >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: `${managerPersona.color || "***REMOVED***6366F1"}18`,
                      color: managerPersona.color || "***REMOVED***6366F1",
                    }}
                  >
                    Always Active
                  </span>
                      ...
                      {REVIEWER_RESPONSIBILITIES.map((resp, i) => (
                        <li key={i} className="text-xs text-muted-foreground flex items-center gap-2">
                          <div
                            ...
                            style={{ backgroundColor: managerPersona.color || "***REMOVED***6366F1" }}
                          />
                          {resp}
                        </li>
                      ))}
        ...
        <div className="grid gap-4">
          {workerPersonas.map((persona) => (
            <div
              ...
              style={{ borderColor: `${persona.color || "***REMOVED***3B82F6"}40` }}
            >
              <div className="flex items-start gap-4">
                <div
                  className="p-3 rounded-lg"
                  style={{ backgroundColor: `${persona.color || "***REMOVED***3B82F6"}18` }}
                >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span
                      ...
                      style={{
                        backgroundColor: `${persona.color || "***REMOVED***3B82F6"}18`,
                        color: persona.color || "***REMOVED***3B82F6",
                      }}
                    >
