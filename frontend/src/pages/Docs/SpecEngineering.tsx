        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-6">
          ...
          <div>
            ...
            <div className="p-3 bg-muted/50 border border-border rounded-lg">
              <pre className="text-xs text-muted-foreground font-mono whitespace-pre-wrap">{`***REMOVED******REMOVED*** Scope Boundary
DO NOT create:
...
- Any npm packages not listed in Technical Specification`}</pre>
          ...
          <div>
            ...
            <div className="p-3 bg-muted/50 border border-border rounded-lg">
              <pre className="text-xs text-muted-foreground font-mono whitespace-pre-wrap">{`***REMOVED******REMOVED*** File Structure
src/
  components/
    UserTable.tsx          ***REMOVED*** Main data table with sorting
    UserTableRow.tsx       ***REMOVED*** Individual row with actions
    UserFilters.tsx        ***REMOVED*** Filter bar (status, role, date)
  hooks/
    useUsers.ts            ***REMOVED*** React Query hook for /api/users
    useUserMutations.ts    ***REMOVED*** Create/update/delete mutations
  types/
    user.ts                ***REMOVED*** User interface + API types
  __tests__/
    UserTable.test.tsx     ***REMOVED*** Table render + interaction tests`}</pre>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="p-3 bg-muted/50 border border-border rounded-lg">
              <pre className="text-xs text-muted-foreground font-mono whitespace-pre-wrap">{`***REMOVED******REMOVED*** Quality Gates
- npm run lint          ***REMOVED*** ESLint must pass with zero warnings
- npm run typecheck     ***REMOVED*** TypeScript strict mode, no errors
- npm run test          ***REMOVED*** All tests pass, no skipped tests
- npm run build         ***REMOVED*** Production build completes`}</pre>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="p-3 bg-muted/50 border border-border rounded-lg">
              <pre className="text-xs text-muted-foreground font-mono whitespace-pre-wrap">{`***REMOVED******REMOVED*** API Specification

***REMOVED******REMOVED******REMOVED*** POST /api/users
Request:
...
Add some tests.`}</pre>
          ...
          <div>
            ...
            <div className="p-4 bg-green-500/5 border border-green-500/20 rounded-lg">
              <pre className="text-xs text-muted-foreground font-mono whitespace-pre-wrap">{`***REMOVED******REMOVED*** Overview
