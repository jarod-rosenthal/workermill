...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className="absolute inset-0 bg-[***REMOVED***0a0f1a]/70 backdrop-blur-xl border-b border-white/5" />
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <nav className="relative lg:hidden border-t border-white/5 bg-[***REMOVED***0a0f1a]/95 backdrop-blur-xl">
