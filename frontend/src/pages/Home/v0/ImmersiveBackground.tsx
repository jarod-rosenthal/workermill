...
function DepthGrid() {
  ...
  return (
    <group ref={gridRef} position={[0, -8, -20]} rotation={[Math.PI * -0.4, 0, 0]}>
      <gridHelper args={[60, 40, "***REMOVED***14b8a6", "***REMOVED***14b8a6"]} />
...
function Scene() {
  return (
    <>
      ...
      <GlassOrb position={[8, 2, -10]} scale={1.2} color="***REMOVED***14b8a6" speed={0.3} />
      <GlassOrb position={[-6, 1, -12]} scale={1.5} color="***REMOVED***3b82f6" speed={0.25} />
      <GlassOrb position={[4, -1, -8]} scale={0.8} color="***REMOVED***22d3ee" speed={0.35} />
      <GlassOrb position={[-4, 3, -14]} scale={1} color="***REMOVED***8b5cf6" speed={0.2} />
      <GlassOrb position={[10, -2, -16]} scale={0.6} color="***REMOVED***14b8a6" speed={0.4} />
