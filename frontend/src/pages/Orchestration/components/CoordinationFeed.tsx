      ...
      >
        ...
        {hasNewMessages && (
          <button
            ...
            className="absolute bottom-4 left-1/2 -translate-x-1/2 px-3 py-1.5 text-[var(--mc-text-xs)] font-medium bg-[var(--mc-status-active)] text-[var(--mc-bg-void)] rounded-full shadow-lg hover:bg-[***REMOVED***00b8e0] transition-colors"
          >
            New messages ↓
          </button>
        )}
