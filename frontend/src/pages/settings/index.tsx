  ...
  const fetchSettings = useCallback(async () => {
    ...
    try {
      ...
      const loadedSettings: Settings = {
        ...
        taskPlanningMode: isProPlan ? "simplified" : (data.taskPlanningMode || data.planningMode || "simplified"),
        prdPlanningMode: isProPlan ? "simplified" : (data.prdPlanningMode || data.planningMode || "simplified"),
        ...
        autoImproveEnabled: data.autoImproveEnabled ?? false,
