        ...
        <View className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
          <MarkdownDisplay
            style={{
              ...
              text: { color: '#e2e8f0' },
              paragraph: { marginTop: 0, marginBottom: 8, color: '#e2e8f0' },
              heading1: { color: '#f1f5f9', fontSize: 20, fontWeight: 'bold', marginBottom: 8 },
              heading2: { color: '#f1f5f9', fontSize: 18, fontWeight: 'bold', marginBottom: 6 },
              heading3: { color: '#f1f5f9', fontSize: 16, fontWeight: '600', marginBottom: 4 },
              heading4: { color: '#f1f5f9', fontSize: 15, fontWeight: '600' },
              strong: { color: '#f1f5f9', fontWeight: 'bold' },
              em: { color: '#cbd5e1', fontStyle: 'italic' },
              link: { color: '#818cf8', textDecorationLine: 'underline' },
              blockquote: { backgroundColor: '#1e293b', borderLeftColor: '#475569', borderLeftWidth: 3, paddingLeft: 12, paddingVertical: 4 },
              code_inline: { backgroundColor: '#1e293b', color: '#a5f3fc', fontFamily: 'monospace', paddingHorizontal: 4, borderRadius: 3 },
              code_block: { backgroundColor: '#1e293b', color: '#e2e8f0', fontFamily: 'monospace', padding: 12, borderRadius: 6 },
              fence: { backgroundColor: '#1e293b', color: '#e2e8f0', fontFamily: 'monospace', padding: 12, borderRadius: 6 },
              list_item: { color: '#e2e8f0' },
              bullet_list: { color: '#e2e8f0' },
              ordered_list: { color: '#e2e8f0' },
              bullet_list_icon: { color: '#94a3b8' },
              ordered_list_icon: { color: '#94a3b8' },
              table: { borderColor: '#334155' },
              thead: { backgroundColor: '#1e293b' },
              th: { color: '#f1f5f9', padding: 6, borderColor: '#334155' },
              td: { color: '#e2e8f0', padding: 6, borderColor: '#334155' },
