/**
 * Worker Decision Engine (portable subset)
 *
 * Pure functions for error classification, quality evaluation, review parsing,
 * question routing, and provider routing. Extracted from
 * api/src/services/worker-decision-engine.ts — no DB, no HTTP, no filesystem.
 */
