...
export const description = "List directory contents in a tree format. Shows file names, types, and sizes. " +
...
export const parameters = {
    ...
    properties: {
        ...
        ignore: {
            type: "array",
            items: { type: "string" },
            description: 'Glob patterns to exclude (e.g., ["node_modules", "dist"]). Defaults to node_modules and .git.',
        },
        maxDepth: {
            type: "number",
...
export async function execute({ path: dirPath, ignore, maxDepth = 3, maxFiles = 1000, }) {
    try {
