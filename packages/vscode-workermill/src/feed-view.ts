...
<html><head><style>
  body { background: transparent; color: ***REMOVED***808080; font-family: -apple-system, sans-serif; font-size: 12px; display: flex; align-items: center; justify-content: center; height: 100vh; text-align: center; }
</style></head>
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Blocker */
  .blocker-alert { background: ***REMOVED***3a1a1a; border: 1px solid var(--red); border-radius: 5px; padding: 8px; margin: 6px; display: none; flex-shrink: 0; }
