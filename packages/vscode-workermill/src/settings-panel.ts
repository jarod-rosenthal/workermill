    ...
    window.addEventListener("message", (event) => {
      ...
      if (msg.type === "integrations-loaded") {
        ...
        if (configuredScm.length > 0) {
          ...
          scmContainer.innerHTML = '<p style="color:var(--muted)">No source control connected. Configure in <a href="***REMOVED***" id="btn-scm-web-link" style="color:var(--vscode-textLink-foreground)">web settings</a>.</p>';
