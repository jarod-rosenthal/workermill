...
<body>
  ...
  <div id="content" class="hidden">
    ...
    <div class="section">
      ...
      <div id="tracker-upgrade" class="upgrade-hint hidden">Upgrade to Pro to unlock all issue trackers. <a id="btn-upgrade-tracker" href="#">View plans</a></div>
    ...
    <div class="section">
      ...
      <div id="scm-upgrade" class="upgrade-hint hidden">Upgrade to Pro to connect Bitbucket and GitLab. <a id="btn-upgrade-scm" href="#">View plans</a></div>
