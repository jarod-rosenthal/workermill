...
window.addEventListener("message", (event) => {
  ...
  if (msg.type === "taskDetail") {
    ...
    if (d.githubPrUrl) {
      ...
      prLink.textContent = prNum ? "PR ***REMOVED***" + prNum[1] : d.githubPrUrl;
