...
***REMOVED******REMOVED******REMOVED*** Step 1: Get Task Details
...
***REMOVED******REMOVED******REMOVED*** Step 3: Check if Epic/PRD Task
...
***REMOVED******REMOVED******REMOVED*** Step 4: Common Failure Patterns
...
***REMOVED******REMOVED******REMOVED*** Step 5: Suggested Actions
...
***REMOVED******REMOVED******REMOVED*** Step 6: Document Findings
Summarize:
...
***REMOVED******REMOVED*** Task Lifecycle Steps
...
***REMOVED******REMOVED******REMOVED*** Step 2: Create the Task
...
***REMOVED******REMOVED******REMOVED*** Step 3: Monitor Initial Status
...
***REMOVED******REMOVED******REMOVED*** Step 4: Monitor Execution
...
***REMOVED******REMOVED******REMOVED*** Step 5: Handle Completion States
...
***REMOVED******REMOVED******REMOVED*** Step 6: Post-Completion
...
***REMOVED******REMOVED*** Epic Review Steps

***REMOVED******REMOVED******REMOVED*** Step 1: Get Parent Task Overview
...
***REMOVED******REMOVED******REMOVED*** Step 3: Check Child Task Status
...
***REMOVED******REMOVED******REMOVED*** Step 4: Review Expert Collaboration
...
***REMOVED******REMOVED******REMOVED*** Step 5: Identify Issues
...
***REMOVED******REMOVED******REMOVED*** Step 6: Take Action
...
***REMOVED******REMOVED******REMOVED*** Summary Format
...
***REMOVED******REMOVED*** Optimization Analysis Steps

***REMOVED******REMOVED******REMOVED*** Step 1: Get Current Settings
...
***REMOVED******REMOVED******REMOVED*** Step 2: Get Usage Statistics
Use \`workermill_dashboard_stats\` to understand current usage:
- Task counts by status
- Cost breakdown
- Recent activity

***REMOVED******REMOVED******REMOVED*** Step 3: Get Provider/Model Info
Use \`workermill_get_models\` and \`workermill_get_providers\` to understand available options.

***REMOVED******REMOVED******REMOVED*** Step 4: Cost Optimization Recommendations
...
***REMOVED******REMOVED******REMOVED*** Step 5: Performance Optimization
...
***REMOVED******REMOVED******REMOVED*** Step 6: Reliability Optimization
...
***REMOVED******REMOVED******REMOVED*** Step 7: Suggest Changes
Based on the analysis, recommend specific \`workermill_update_settings\` calls.

Example optimizations:
\`\`\`
***REMOVED*** For cost-conscious teams
...
***REMOVED*** For speed-focused teams
workermill_update_settings({
...
***REMOVED******REMOVED******REMOVED*** Step 8: Verify Integration Health
