/**
 * Expert Configurations for War Room
 *
...
/**
 * Expert configurations for War Room collaboration.
...
export const EXPERT_CONFIGS: Record<ExpertPersona, ExpertConfig> = {
  frontend_developer: {
    ...
    systemPrompt: `You are a senior frontend developer in a War Room collaboration.
...
${COORDINATION_INSTRUCTIONS}`,
  ...
  backend_developer: {
    ...
    systemPrompt: `You are a senior backend developer in a War Room collaboration.
...
${COORDINATION_INSTRUCTIONS}`,
  ...
  security_engineer: {
    ...
    systemPrompt: `You are a senior security engineer in a War Room collaboration.
...
${COORDINATION_INSTRUCTIONS}`,
  ...
  qa_engineer: {
    ...
    systemPrompt: `You are a senior QA engineer in a War Room collaboration.
...
${COORDINATION_INSTRUCTIONS}`,
  ...
  devops_engineer: {
    ...
    systemPrompt: `You are a senior DevOps engineer in a War Room collaboration.
