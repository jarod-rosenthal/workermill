 ...
 * War Room Types
 *
 * Shared type definitions for the War Room multi-agent collaboration service.
 */

/**
 * Expert persona types that can participate in War Room collaboration.
 */
...
/**
 * State of an expert in the War Room.
 */
...
/**
 * War Room configuration from environment.
 */
