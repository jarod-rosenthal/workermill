...
```bash
IMAGE_NAME="593971626975.dkr.ecr.us-east-1.amazonaws.com/oncallshift-dev/backend:v1" \
DOCKERFILE_PATH="./Dockerfile" \
CONTEXT_DIR="." \
BUILD_ARGS="NODE_ENV=production,VERSION=1.0.0" \
AWS_REGION="us-east-1" \
CACHE_REPO="593971626975.dkr.ecr.us-east-1.amazonaws.com/oncallshift-cache" \
...
IMAGE_URI="593971626975.dkr.ecr.us-east-1.amazonaws.com/oncallshift-dev/backend:v1" \
AWS_REGION="us-east-1" \
...
## Oncallshift Deployment Configuration
...
IMAGE_NAME="593971626975.dkr.ecr.us-east-1.amazonaws.com/pagerduty-lite-dev-api:$(git rev-parse --short HEAD)" \
