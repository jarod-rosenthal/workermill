...
***REMOVED******REMOVED*** Deployment Result Reporting
...
***REMOVED******REMOVED******REMOVED*** When to Use `::result::deployed`
...
***REMOVED******REMOVED******REMOVED*** ALWAYS Attempt the Build
...
***REMOVED******REMOVED******REMOVED*** Do NOT Infer Current State From Git History
...
***REMOVED******REMOVED******REMOVED*** Correct Behavior When Build Fails
...
***REMOVED******REMOVED******REMOVED*** Example: Build Failed Due to Infrastructure
...
***REMOVED******REMOVED******REMOVED*** Result Markers Summary for Deployment Scenarios
