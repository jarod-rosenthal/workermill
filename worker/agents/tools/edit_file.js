...
module.exports = {
  name: 'edit_file',
  description: 'Edit a file by finding and replacing text. The old_string must be unique in the file (or use replaceAll for multiple occurrences). Use this instead of write_file when making targeted changes to existing files.',
  parameters: {
    type: 'object',
    properties: {
      path: {
  ...
  async execute({ path: filePath, old_string, new_string, replaceAll = false }) {
    try {
      ...
      if (!content.includes(old_string)) {
        ...
        return {
          ...
          filePreview: preview.length < 2000 ? preview : preview.slice(0, 2000) + '\n... [truncated]'
        };
      }
