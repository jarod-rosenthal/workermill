...
module.exports = {
  name: 'read_file',
  description: 'Read the contents of a file. Returns the file content as a string. Supports text files of any type.',
  parameters: {
    type: 'object',
    properties: {
      path: {
  ...
  async execute({ path: filePath, encoding = 'utf8', maxLines, startLine }) {
    try {
