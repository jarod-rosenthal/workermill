...
module.exports = {
  name: 'write_file',
  description: 'Write content to a file. Creates the file if it does not exist, and creates any necessary parent directories. Overwrites existing content.',
  parameters: {
    type: 'object',
    properties: {
      path: {
  ...
  async execute({ path: filePath, content, encoding = 'utf8', append = false }) {
    try {
