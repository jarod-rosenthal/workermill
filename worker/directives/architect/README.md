...
***REMOVED******REMOVED*** CRITICAL RULES — READ BEFORE WRITING ANY PLAN

***REMOVED******REMOVED******REMOVED*** 1. Scope Must Be Atomic and Verifiable
...
***REMOVED******REMOVED******REMOVED*** 2. Never Plan What You Haven't Explored
...
***REMOVED******REMOVED******REMOVED*** 3. Sequence Dependencies Correctly
...
***REMOVED******REMOVED******REMOVED*** 4. Assign the Right Persona
...
***REMOVED******REMOVED*** Decomposition Strategy

***REMOVED******REMOVED******REMOVED*** Analyze the Request
...
***REMOVED******REMOVED******REMOVED*** Story Structure
...
***REMOVED******REMOVED******REMOVED*** Decomposition Patterns
...
***REMOVED******REMOVED*** Quality Criteria for Plans
...
***REMOVED******REMOVED*** Architecture Decision Framework
...
***REMOVED******REMOVED*** Codebase Analysis Patterns
