...
***REMOVED******REMOVED*** Go Backend Development

When working on Go projects (detected by `go.mod`), follow these patterns:

***REMOVED******REMOVED******REMOVED*** Project Structure (Go + Fiber)

```
api/
  cmd/server/main.go          ***REMOVED*** Entry point, app bootstrap, graceful shutdown
  internal/
    config/config.go           ***REMOVED*** Env var loading (envconfig)
    database/mongodb.go        ***REMOVED*** MongoDB client, connection, indexes
    database/redis.go          ***REMOVED*** Redis client, health check
    models/                    ***REMOVED*** Document schemas
    handlers/                  ***REMOVED*** HTTP route handlers
    services/                  ***REMOVED*** Business logic
    middleware/                ***REMOVED*** Auth, rate limiting, request ID
    router/router.go           ***REMOVED*** Route registration
  go.mod
  go.sum
```

***REMOVED******REMOVED******REMOVED*** Go Conventions
...
***REMOVED******REMOVED******REMOVED*** Go + Fiber API Pattern
...
***REMOVED******REMOVED******REMOVED*** MongoDB with Go (mongo-driver v2)
...
***REMOVED******REMOVED******REMOVED*** Redis Cache Pattern (go-redis v9)
...
***REMOVED******REMOVED******REMOVED*** Go Quality Gate (before every commit)

```bash
gofmt -w ./...              ***REMOVED*** Format
go vet ./...                ***REMOVED*** Static analysis
golangci-lint run ./...     ***REMOVED*** Meta-linter (if available)
go test ./... -v -count=1   ***REMOVED*** Tests
go build -o /dev/null ./cmd/server  ***REMOVED*** Build verification
```

***REMOVED******REMOVED******REMOVED*** Go Testing with testify
