...
***REMOVED******REMOVED*** PRD Child Task Workflow
...
```bash
***REMOVED*** 1. Make your changes
***REMOVED*** 2. Run tests
npm test

***REMOVED*** 3. Create PR to feature branch (TARGET_BRANCH)
***REMOVED*** Use the execution script which handles all SCM providers:
TARGET_BRANCH="${TARGET_BRANCH}" node /app/execution-compiled/git/create_pr.js

***REMOVED*** 4. Auto-merge the PR (no deployment!)
***REMOVED*** For GitHub:
gh pr merge --squash --delete-branch
***REMOVED*** For Bitbucket: Use Bitbucket API
curl -s -X POST \
...
***REMOVED*** 5. Output result to unblock dependents
echo "::result::deployed"  ***REMOVED*** Note: No actual deployment was done
```
