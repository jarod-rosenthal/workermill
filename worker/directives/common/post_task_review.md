...
***REMOVED******REMOVED******REMOVED*** 1. Update Self-Annealing Notes
...
***REMOVED******REMOVED******REMOVED*** [Date] - [Brief description]
...
***REMOVED******REMOVED******REMOVED*** 2. Create Follow-up Tickets
...
***REMOVED******REMOVED******REMOVED*** 3. Update Metrics
...
***REMOVED******REMOVED*** Review Templates

***REMOVED******REMOVED******REMOVED*** Template: Bug Fix Review

```markdown
***REMOVED******REMOVED*** Post-Task Review: PROJ-XXX
...
***REMOVED******REMOVED******REMOVED*** Time Breakdown
- Understanding: X min
- Finding code: X min
...
***REMOVED******REMOVED******REMOVED*** What Helped
- [Tool/doc/pattern that was useful]

***REMOVED******REMOVED******REMOVED*** What Would Have Helped
- [Missing thing that would have sped this up]

***REMOVED******REMOVED******REMOVED*** Improvements Made
- Updated [directive/script] with [learning]
- Created follow-up ticket PROJ-YYY for [issue]
```

***REMOVED******REMOVED******REMOVED*** Template: Feature Implementation Review

```markdown
***REMOVED******REMOVED*** Post-Task Review: PROJ-XXX

***REMOVED******REMOVED******REMOVED*** Implementation Summary
Implemented [feature] using [approach/patterns].

***REMOVED******REMOVED******REMOVED*** Decisions Made
...
***REMOVED******REMOVED******REMOVED*** Follow-ups Created
- PROJ-YYY: [related work identified]
```

***REMOVED******REMOVED*** Edge Cases

***REMOVED******REMOVED******REMOVED*** Task Was Blocked
...
***REMOVED******REMOVED******REMOVED*** Multiple Issues Found
...
***REMOVED******REMOVED******REMOVED*** No Issues Found
