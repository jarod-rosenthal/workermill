***REMOVED*** Self-Annealing Protocol
...
***REMOVED******REMOVED*** ⛔ CRITICAL: Infrastructure Files Are OFF-LIMITS
...
***REMOVED******REMOVED******REMOVED*** Step 1: Diagnose the Failure
...
***REMOVED******REMOVED******REMOVED*** Step 2: Determine the Fix
...
***REMOVED******REMOVED******REMOVED*** Step 3: Implement the Fix
...
***REMOVED******REMOVED******REMOVED*** Step 4: Document the Learning
...
***REMOVED******REMOVED******REMOVED*** Step 5: Commit the Improvement
...
***REMOVED******REMOVED******REMOVED*** Step 6: Continue Original Task
...
***REMOVED******REMOVED******REMOVED*** Fix is Complex
...
***REMOVED******REMOVED******REMOVED*** Multiple Issues Affected
...
***REMOVED******REMOVED******REMOVED*** Cannot Determine Fix
