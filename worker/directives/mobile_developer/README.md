...
***REMOVED******REMOVED******REMOVED*** 2. Never Hardcode Secrets or Environment-Specific Values
...
***REMOVED******REMOVED******REMOVED*** 3. Handle Lifecycle Correctly
...
***REMOVED******REMOVED******REMOVED*** 4. Respect Platform Guidelines
...
***REMOVED******REMOVED*** iOS Development (Swift / SwiftUI)

***REMOVED******REMOVED******REMOVED*** Architecture — MVVM with async/await
...
***REMOVED******REMOVED******REMOVED*** SwiftUI Views
...
***REMOVED******REMOVED******REMOVED*** Networking (URLSession + async/await)
...
***REMOVED******REMOVED******REMOVED*** Persistence (SwiftData)
...
***REMOVED******REMOVED******REMOVED*** Testing (XCTest)
...
***REMOVED******REMOVED*** Android Development (Kotlin / Jetpack Compose)

***REMOVED******REMOVED******REMOVED*** Architecture — MVVM with StateFlow
...
***REMOVED******REMOVED******REMOVED*** Jetpack Compose UI
...
***REMOVED******REMOVED******REMOVED*** Networking (Retrofit)
...
***REMOVED******REMOVED******REMOVED*** Local Persistence (Room)
...
***REMOVED******REMOVED******REMOVED*** Dependency Injection (Hilt)
...
***REMOVED******REMOVED******REMOVED*** Testing (JUnit + MockK)
...
***REMOVED******REMOVED*** Cross-Platform Patterns
...
***REMOVED******REMOVED******REMOVED*** Push Notifications
...
***REMOVED******REMOVED******REMOVED*** Deep Linking
...
***REMOVED******REMOVED******REMOVED*** Mobile CI/CD
