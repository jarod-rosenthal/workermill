...
***REMOVED******REMOVED*** Common Quality Issues

***REMOVED******REMOVED******REMOVED*** Issue: Over-Promising
...
***REMOVED******REMOVED******REMOVED*** Issue: Technical Jargon
...
***REMOVED******REMOVED******REMOVED*** Issue: Incomplete Instructions

**Bad:** "Check your GitHub settings."
**Good:** "Go to Settings → Integrations → GitHub, then click 'Reconnect'."

***REMOVED******REMOVED******REMOVED*** Issue: Vague Next Steps
...
***REMOVED******REMOVED*** Response Review Examples

***REMOVED******REMOVED******REMOVED*** Example 1: Good Response
...
***REMOVED******REMOVED******REMOVED*** Example 2: Needs Improvement
...
***REMOVED******REMOVED*** Final Review Process
...
```
::confidence::85      ***REMOVED*** Your quality score
::response::posted    ***REMOVED*** Response successfully sent
::needs_review::true  ***REMOVED*** Flag for human review (if score 60-80%)
```
