...
**If the ticket, PRD, or task description specifies a dependency version, USE THAT VERSION.** Do NOT downgrade or "fix" versions you don't recognize — your training data has a cutoff and newer releases exist. Trust the spec over your knowledge.`;
  ...
  private async pollGitHubActionsCI(
    ...
    if (lastRunId) {
      const summary = `CI did not complete within 10 minutes (run ***REMOVED***${lastRunId})`;
...
${storyReason
  ? `***REMOVED******REMOVED******REMOVED*** Your Story's Required Fix
${storyReason}

***REMOVED******REMOVED******REMOVED*** Full Review Context (for reference — focus on YOUR story above)
...
`
    ...
    const siblingFilesSection = mergedSiblingFiles && mergedSiblingFiles.length > 0
      ? `***REMOVED******REMOVED*** ⛔ DO NOT DELETE — Files From Sibling Stories
...
${mergeIssuesSection}${siblingFilesSection}${qandASection}***REMOVED******REMOVED*** Your Task
...
***REMOVED******REMOVED******REMOVED*** 📬 Live Communication Channel
