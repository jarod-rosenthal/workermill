...
export class InlineImprover {
  ...
  private buildImprovementPrompt(): string {
    return `***REMOVED*** WorkerMill Improvement Analysis Task
...
***REMOVED******REMOVED******REMOVED*** Step 1: Fetch Task Logs
...
***REMOVED******REMOVED******REMOVED*** Step 2: Analyze for Improvements
...
***REMOVED******REMOVED******REMOVED*** Step 3: Clone WorkerMill Repository (if improvements needed)
...
***REMOVED******REMOVED******REMOVED*** Step 4: Make Improvements

For Dockerfile changes (missing tools):
\`\`\`bash
***REMOVED*** Edit worker/Dockerfile to add the missing tool
***REMOVED*** Example: add "jq" for JSON parsing
\`\`\`

For directive changes (worker instructions):
\`\`\`bash
***REMOVED*** Edit the relevant directive file in worker/directives/
\`\`\`

***REMOVED******REMOVED******REMOVED*** Step 5: Commit and Push
...
***REMOVED******REMOVED******REMOVED*** Step 6: Output Results
