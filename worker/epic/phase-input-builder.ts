...
export function formatInputBundleForPrompt(bundle: PhaseInputBundle): string {
  ...
  // Story requirements
  sections.push(`***REMOVED******REMOVED*** Story Requirements
...
`);
  ...
  if (
    ...
    sections.push(`***REMOVED******REMOVED*** Analysis Context
...
`);
  ...
  // Repo state
  sections.push(`***REMOVED******REMOVED*** Current Repository State
...
`);
  ...
  if (bundle.unitContext) {
    sections.push(`***REMOVED******REMOVED*** Unit Context
...
`);
    ...
    if (bundle.unitContext.relevantSnippets.length > 0) {
      sections.push(`***REMOVED******REMOVED*** Pre-Loaded File Contents
...
`);
      for (const snippet of bundle.unitContext.relevantSnippets) {
        sections.push(`***REMOVED******REMOVED******REMOVED*** ${snippet.filePath}
...
`);
  ...
  if (bundle.verifyContext) {
    sections.push(`***REMOVED******REMOVED*** Verify Context
...
`);
  ...
  if (bundle.fixContext) {
    sections.push(`***REMOVED******REMOVED*** Fix Context
...
${bundle.fixContext.commandOutputs
  .map(
    (o) => `
***REMOVED******REMOVED******REMOVED*** \`${o.command}\` (exit code: ${o.exitCode})
\`\`\`
${o.truncatedLog}
\`\`\`
`
...
`);
  ...
  if (bundle.integrateContext) {
    sections.push(`***REMOVED******REMOVED*** Integrate Context
...
${bundle.integrateContext.allUnitOutputs
  .map(
    (u) => `
***REMOVED******REMOVED******REMOVED*** Unit ${u.unitIndex}
