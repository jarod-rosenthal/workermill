...
async function runKanikoTask(imageName, dockerfilePath, buildArgs, cacheRepo, region) {
    ...
    const kanikoCommand = [
        "--context",
        `git://github.com/${githubRepo}***REMOVED***refs/heads/${gitBranch}`,
        "--dockerfile",
        dockerfilePath,
        "--destination",
        imageName,
    ...
    console.error(`[build_container] Git context: git://github.com/${githubRepo}***REMOVED***refs/heads/${gitBranch}`);
