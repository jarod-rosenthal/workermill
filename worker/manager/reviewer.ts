...
***REMOVED******REMOVED*** SCM Provider Support
...
export class PRReviewer {
  ...
  private buildReviewPrompt(): string {
    const previousFeedback = this.config.reviewFeedback
      ? `***REMOVED******REMOVED*** ⚠️ Previous Review Feedback (REVISION ATTEMPT)
...
***REMOVED******REMOVED*** SCM Provider Notice
${scmNotice}
...
***REMOVED******REMOVED*** Jira Summary
${this.config.jiraSummary || "No summary provided"}

***REMOVED******REMOVED*** Jira Description
${this.config.jiraDescription || "No description provided"}

${previousFeedback}***REMOVED******REMOVED*** Instructions
